...
import { CreditCard, BookOpen, Mail, Users, ArrowLeft, SlidersHorizontal, Globe, Trash2, Printer, Receipt, Clock, Smartphone, Percent, Wallet } from "lucide-react";
...
const settingsSections = [
  ...
  { href: "/settings/reconciliation", label: "Cash & Card Reconciliation", icon: Wallet, description: "Auto-fetch UTAP/Bank emails. IMAP inbox, auto-forward setup" },
  ...
  { href: "/settings/clear-local-data", label: "Clear local data on apps", icon: Smartphone, description: "Bağlı cihazlardan yerel satış verilerini sil (POS sync sonrası)" },
